    ...
    <div className="mt-12">
      {isAdmin && (
        <form
          ...
          className="mb-10 grid grid-cols-1 gap-4 rounded-3xl border border-black/10 bg-[#f7f7f7] p-5 md:grid-cols-2"
        >
          <input
            type="file"
            accept="image/*"
          ...
          <input
            ...
            placeholder="Enter house area e.g. 250 m²"
            className="rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm outline-none"
          />
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
        {visibleProjects.map((project) => (
          <motion.div
            ...
            className="group relative overflow-hidden rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.12)]"
          >
            <Link href={`/projects/${project.id}`}>
              <div className="relative h-[300px] w-full overflow-hidden">
                ...
                <div className="absolute left-4 top-4 z-20 flex flex-col gap-2">
                  {project.location && (
                    <div className="rounded-2xl bg-black/35 px-3 py-2 text-xs font-semibold text-white backdrop-blur-md">
                      📍 {project.location}
                    </div>
                  )}
            ...
            {isAdmin && (
              <div className="flex flex-wrap gap-3 bg-[#f7f7f7] p-5">
                <button
                  type="button"
